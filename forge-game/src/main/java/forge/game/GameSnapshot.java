// /usr/src/app/forge-game/src/main/java/forge/game/GameSnapshot.java
...
public class GameSnapshot {
    ...
    private record UnorderedEntities(Player toPlayer, Card fromCard, Card newCard, ZoneType fromType, int zonePosition) implements Comparable<UnorderedEntities> {
        @Override
    ...
    public class SnapshotEntityMap implements IEntityMap {
        @Override
        public Game getGame() {
            return restore ? origGame : newGame;
        }
